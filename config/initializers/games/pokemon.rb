GAMES[:pokemon] = {
    ...
    columns: {
        ...
        slot_one_type: {
            help: "This is the primary type of this pokemon. If you don't have one yet, either leave the slot open or use your starter. If your game does not have this type, reroll. You can swap a pokemon out to use HMs or hatch eggs",
            chance_of_multiple: 0,
            min: 1,
            max: 1,
            options: [
        ...
        modifiers: {
            ...
            options: [
                ...
                :'Attempt to avoid all wild pokemon battles',
                ...
                :'You cannot use the PC except to release pokemon',
                ...
                :'The first pokemon in each slot is the only pokemon evolution tree you may use in that slot',
                :'No healing during trainer battles',
                :'No items during trainer battles',
                :'The Ash Ketchum run - Every time you beat a gym you must release all but your starter pokemon and start your party over',
                :'No Legendaries',
