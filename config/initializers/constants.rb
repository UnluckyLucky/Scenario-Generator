        ...
        columns: {
            country_type: {
                sub_trees: [
                    ...
                    :adal, :algiers, :alodia, :ardalan, :baluchistan, :bohtan, :djerid, :ethiopia, :fezzan, :gazikumukh, :granada, :haasa, :hedjaz, :kaffa, :makuria, :marehan, :the_mamluks, :medri_bahri, :morocco, :mzab, :najd, :oman, :shammar, :shirvan, :tabarestan, :tlemcen, :touggourt, :tripoli, :tunisia, :warsangali, :yemen,
